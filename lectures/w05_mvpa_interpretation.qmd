...
## Standardized Var/Disturbance Variance

Variance in parent ed: Always 1

Disturbance variance: the proportion of variance in this endogenous variable that is NOT explained by its predictors
...
$$\text{direct} + \text{indirect(Family)} + \text{indirect(Danger)}$$ 
...
Correlated disturbance variances of PTR & Symptoms

— The two variables are not on the same causal pathway, so this is fine. 

## Real world impact

What impact could you use these results for?
...
Lamaku > Assignments > w2 Rlab.

1. What do the regressions models tell us?
2. What does the SEM model tell us that the regression models didn't capture?
